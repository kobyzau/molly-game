...
import com.codenjoy.dojo.molly.MollySolver;
...
public class JavaRunner {
  ...
  private String url =
      "https://dojorena.io/codenjoy-contest/board/player/dojorena1018?code=8316540527408090660";
  ...
  public void run(String[] args) {
    ...
    WebSocketRunner.runClient(
        url, new MollySolver(new AdaptiveMollyBehavior()), loadJavaBoard(game));
  }

  private void printInfo(String source) {
    PrintUtils.printf(
        "Got from %s:\n" + "\t 'GAME': '%s'\n" + "\t 'URL':  '%s'\n", INFO, source, game, url);
  }
